...
const mockParams = { category: 'getting-started', slug: 'getting-started-guide' };
...
// ---------------------------------------------------------------------------
const mockSections = [
  { slug: 'getting-started', title: 'Getting Started', description: 'Start here', articleCount: 5 },
  { slug: 'features', title: 'Features', description: 'Platform features', articleCount: 12 },
  { slug: 'troubleshooting', title: 'Troubleshooting', description: 'Fix issues', articleCount: 8 },
  { slug: 'api', title: 'API Reference', description: 'API docs', articleCount: 20 },
];
...
describe('DocsList', () => {
  ...
  it('shows empty state when no articles in category', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/No articles in this category/i)).toBeInTheDocument();
    });
  });
