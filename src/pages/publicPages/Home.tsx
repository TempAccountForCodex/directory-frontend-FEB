...
const WhyChooseUs = lazy(() => import('../../components/publicComponents/Home/WhyChooseUs'));
const HowItWorks = lazy(() => import('../../components/publicComponents/Home/HowItWorks'));
...
const PricingSection = lazy(() => import('../../components/publicComponents/Home/PricingSection'));
const FeatureListing = lazy(() => import('../../components/publicComponents/Home/FeaturedListing'));
