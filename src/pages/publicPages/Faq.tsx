      ...
      >
        ...
        >
          <Box
            sx={{
              ...
              '&::before': {
                ...
                position: 'absolute',
                inset: 0,
                background: 'linear-gradient(145deg, rgba(5,12,17,0.78), rgba(6,15,21,0.48))',
                zIndex: 0,
              },
            }}
          >
            <Box sx={{ pt: 1.2, pb: 1.2, position: 'relative', zIndex: 1 }}>
              ...
              >
                Find clear answers for onboarding, listings, approvals, billing, and profile
                visibility.
              </Typography>
              <Divider sx={{ borderColor: 'rgba(255,255,255,0.2)', mb: 2, mt: 0.6 }} />
          ...
          <Box sx={{ width: { xs: '100%', lg: '70%' } }}>
            ...
            >
              Browse quick answers below. If you still need help, send your details and our team
