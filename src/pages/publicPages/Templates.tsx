...
const STATIC_TEMPLATES: StaticTemplate[] = [
  {
    ...
    name: "Modern",
    description:
      "Clean and conversion-focused modern business landing template.",
    type: "website",
    category: "business",
    version: "1.0.0",
  ...
  },
  {
    ...
    slug: "minimal",
    name: "Minimal",
    description: "Minimal and fast template with strong typography hierarchy.",
    type: "website",
    category: "business",
    version: "1.0.0",
    previewImage: "/assets/templateAssets/images/dummy/templateFeature.png",
  },
  {
    ...
    slug: "premium",
    name: "Premium",
    description: "Premium visual style for high-end service brands.",
    type: "website",
    category: "agency",
    version: "1.0.0",
    previewImage: "/assets/templateAssets/images/dummy/templateFeature.png",
  ...
  {
    id: "static-store-grid",
    slug: "store-grid",
    name: "Store Grid",
    description: "Grid-based store template for product catalog browsing.",
    type: "store",
    category: "ecommerce",
    version: "1.0.0",
    previewImage: "/assets/templateAssets/images/dummy/templateFeature.png",
  ...
  {
    id: "static-store-catalog",
    slug: "store-catalog",
    name: "Store Catalog",
    description: "Catalog-first store template designed for conversion.",
    type: "store",
    category: "ecommerce",
    version: "1.0.0",
    previewImage: "/assets/templateAssets/images/dummy/templateFeature.png",
