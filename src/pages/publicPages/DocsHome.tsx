...
const SectionSkeleton = memo(() => (
  <Card elevation={0} sx={{ border: '1px solid', borderColor: 'divider', borderRadius: 3, p: 3 }}>
    <Skeleton variant="rectangular" width={52} height={52} sx={{ borderRadius: 2, mb: 2 }} />
  ...
  return (
    <Container maxWidth="lg" sx={{ py: { xs: 4, md: 8 } }}>
      ...
      <Box sx={{ textAlign: 'center', mb: { xs: 4, md: 6 } }}>
        ...
        >
          Find guides, tutorials, and API references to help you get the most out of the platform.
        </Typography>
