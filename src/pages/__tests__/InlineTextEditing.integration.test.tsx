...
import type { PreviewWebsite, PreviewPage, PreviewBlock } from '../../utils/previewInjector';
    ...
    const blocks: PreviewBlock[] = [
      {
        id: 'hero1',
        blockType: 'HERO',
        content: { title: 'My Title', subtitle: 'My Sub', buttonText: 'Click Me', buttonUrl: '#' },
        order: 0,
      },
    ];
    const html = generateLivePreview(website, page, blocks, 'http://localhost:5173');
    ...
    const blocks: PreviewBlock[] = [
      {
        id: 'cta1',
        blockType: 'CTA',
        content: { heading: 'CTA Heading', description: 'CTA Desc', buttonText: 'Go' },
        order: 0,
      },
    ];
    const html = generateLivePreview(website, page, blocks, 'http://localhost:5173');
    ...
    const blocks: PreviewBlock[] = [
      {
        id: 'hero1',
        blockType: 'HERO',
        content: { title: '<script>alert(1)</script>', subtitle: '', buttonText: '' },
        order: 0,
      },
    ];
    const html = generateLivePreview(website, page, blocks, 'http://localhost:5173');
