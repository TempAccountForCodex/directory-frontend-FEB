...
export const queryKeys = {
  ...
  websites: {
    ...
    pages: (id: number | string) => ['websites', 'detail', id, 'pages'] as const,
    ...
    approval: (id: number | string) => ['websites', 'detail', id, 'approval'] as const,
    sectionLocks: (id: number | string) => ['websites', 'detail', id, 'sectionLocks'] as const,
    collaborators: (id: number | string) => ['websites', 'detail', id, 'collaborators'] as const,
    activity: (id: number | string) => ['websites', 'detail', id, 'activity'] as const,
    analytics: (id: number | string) => ['websites', 'detail', id, 'analytics'] as const,
  },
  stores: {
    all: () => ['stores'] as const,
    ...
    products: (id: number | string) => ['stores', 'detail', id, 'products'] as const,
    orders: (id: number | string) => ['stores', 'detail', id, 'orders'] as const,
  },
  templates: {
    ...
    history: (id: string | number) => ['templates', 'detail', id, 'history'] as const,
  },
  account: {
    ...
    planPreview: (planCode: string) => ['account', 'planPreview', planCode] as const,
    loginHistory: () => ['account', 'loginHistory'] as const,
    delegated: () => ['account', 'delegated'] as const,
    delegates: () => ['account', 'delegates'] as const,
    delegateInvitesPending: () => ['account', 'delegateInvitesPending'] as const,
  ...
  domains: {
    ...
    subdomainCheck: (subdomain: string) => ['domains', 'subdomainCheck', subdomain] as const,
  },
  analytics: {
    ...
    realtime: (websiteId: number | string) => ['analytics', 'realtime', websiteId] as const,
  ...
  insights: {
    ...
    publicDetail: (id: string | number) => ['insights', 'publicDetail', id] as const,
    categories: () => ['insights', 'categories'] as const,
  },
  content: {
    listings: (params?: Record<string, unknown>) => ['content', 'listings', params ?? {}] as const,
    listing: (id: number | string) => ['content', 'listing', id] as const,
    reviews: (listingId: number | string) => ['content', 'reviews', listingId] as const,
    comments: (listingId: number | string) => ['content', 'comments', listingId] as const,
  ...
  admin: {
    ...
    users: {
      ...
      detail: (id: number | string) => ['admin', 'users', 'detail', id] as const,
