        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <Box sx={{ display: 'flex', gap: 0.25 }}>
              {['★', '★', '★', '★', '★'].map((s, i) => (
                <Typography key={i} sx={{ color: '#fbbf24', fontSize: '0.85rem' }}>
                  {s}
                </Typography>
              ))}
            </Box>
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Box
              sx={{ width: 24, height: 2, bgcolor: theme.primaryColor, display: 'inline-block' }}
            />
          ...
          {data.reviews && data.reviews.length > 0 && (
            <Box sx={{ mt: 5, display: 'flex', alignItems: 'center', gap: 1.5 }}>
              <Box sx={{ display: 'flex', gap: 0.25 }}>
                {['★', '★', '★', '★', '★'].map((s, i) => (
                  <Typography key={i} sx={{ color: '#f59e0b', fontSize: '0.8rem' }}>
                    {s}
                  </Typography>
                ))}
              </Box>
          ...
          {data.contact.phone && (
            <Button
              ...
              sx={{
                ...
                borderRadius: 2,
                px: 4,
                '&:hover': { borderColor: theme.accentColor, bgcolor: 'transparent' },
              }}
            >
              {data.contact.phone}
            </Button>
