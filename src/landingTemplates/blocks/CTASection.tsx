  ...
  return (
    ...
    >
      <FadeIn>
        <Typography
          variant="h3"
          sx={{ fontFamily: theme.fontFamily, fontWeight: 800, color: "#fff", mb: 2 }}
        >
          Ready to Get Started?
        </Typography>
        <Typography sx={{ color: "rgba(255,255,255,0.85)", fontFamily: theme.fontFamily, mb: 4, fontSize: "1.1rem" }}>
  ...
  return (
    ...
    >
      ...
      <FadeIn>
        ...
        <Typography
          variant="h3"
          sx={{ fontFamily: theme.fontFamily, fontWeight: 800, color: theme.headingColor, mb: 2 }}
        >
          Let's Build Something Great
        </Typography>
        <Typography
          sx={{ color: theme.bodyColor, fontFamily: theme.fontFamily, mb: 5, maxWidth: 500, mx: "auto" }}
        >
...
const CTASection: React.FC<CTASectionProps> = ({ data, theme, variant = "gradient" }) => {
