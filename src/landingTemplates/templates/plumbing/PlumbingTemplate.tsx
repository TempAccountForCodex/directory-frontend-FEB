  ...
  return (
    <Box sx={{ bgcolor: '#fbfaf7' }}>
      ...
      >
        ...
        <Container
          maxWidth="xl"
          sx={{ pt: { xs: 0, md: 1 }, pb: { xs: 7, md: 6 }, px: { xs: 2, md: 4 } }}
        >
          ...
          <Grid container spacing={3} sx={{ mt: { xs: 1, md: 2 } }}>
            <Grid xs={12} md={4.5}>
              <FadeIn delay={0.24}>
                ...
                >
                  Home service overview. Trusted experts delivering fast, reliable, and professional
        ...
        <Grid container spacing={{ xs: 5, md: 10 }} alignItems="center">
          ...
          <Grid xs={12} md={8} sx={{ pl: { md: 5 } }}>
            ...
            <FadeIn delay={0.08}>
              ...
              >
                From plumbing leaks to full-system fixes, {data.name} delivers dependable
                maintenance with a cleaner, calmer service experience.
              </Typography>
            </FadeIn>
          </Grid>
        </Grid>
          ...
          >
            <Grid xs={12} md={6}>
              ...
              <FadeIn delay={0.16}>
                ...
                >
                  We combine expertise, reliability, and care to deliver the best experience every
                  time.
                </Typography>
              </FadeIn>
                ...
                <Grid xs={12} sm={6}>
                  <FadeIn delay={0.3} direction="right">
                    ...
                    >
                      ...
                      >
                        We believe in honesty. Every service comes with upfront pricing before work
                        begins.
                      </Typography>
                    </Paper>
                  </FadeIn>
              ...
              <FadeIn delay={0.38}>
                ...
                >
                  <Typography
                    sx={{ fontSize: { xs: '1.4rem', md: '1.1rem' }, fontWeight: 700, mb: 1.5 }}
                  >
                  ...
                  >
                    We ensure everything works perfectly and you&apos;re completely satisfied before
                    we leave.
                  </Typography>
                  <Button
                    variant="contained"
              ...
              <Grid xs={12} md={6}>
                ...
                <Grid container spacing={3} alignItems="stretch">
                  <Grid xs={12} sm={4.5}>
                    ...
                    <Typography
                      sx={{ color: '#f3a515', fontSize: '1.4rem', lineHeight: 1, mt: 1.8 }}
                    >
                      ★★★★★
                    </Typography>
                  ...
                  <Grid xs={12} sm={7.5}>
                    <FadeIn delay={0.12} direction="left">
                      ...
                      >
                        ...
                        >
                          Careful repairs, cleaner finishes, and a more dependable service rhythm
                ...
                {hours.map((item, index) => (
                  <FadeIn key={item.day} delay={0.14 + index * 0.06} direction="right">
                    <Stack
                      ...
                      sx={{ py: 1.3, gap: 2, borderBottom: '1px solid rgba(246,239,229,0.12)' }}
                    >
                      <Typography sx={{ color: '#f6efe5', fontWeight: 600, fontSize: '1.02rem' }}>
                        {item.day}
                      </Typography>
                      <Typography
                        sx={{
                ...
                >
                  {[0, 1].map((index) => (
                    ...
                    >
                      <Box
                        component="img"
                        src={projectImages[index]?.url || plumbingAboutImages[index]}
                        alt="Plumbing detail"
                        sx={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }}
                      />
                    </Box>
