  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Typography sx={{ color: '#0f172f', fontWeight: 700, fontSize: '0.98rem' }}>
            Contact Us
          </Typography>
          <Box
            sx={{
        ...
        <FadeIn>
          <Box sx={{ maxWidth: 760, pt: { xs: 6, md: 10 } }}>
            ...
            >
              ...
              lasting business transformation across industries and markets, maximizing impact.
            </Typography>
...
function ConsultingStudioBody({ data }: { data: TemplateProps['data'] }) {
  ...
  return (
    <>
      ...
      <Box
        id="strategy"
        sx={{ px: { xs: 2, md: 4 }, py: { xs: 7, md: 10 }, bgcolor: '#ffffff', overflow: 'hidden' }}
      >
                  ...
                  <Grid item xs={12} sm={index === 0 ? 12 : 6} key={card.url}>
                    <FadeIn delay={0.08 + index * 0.08} direction="left">
                      ...
                      >
                        ...
                        <Box sx={{ p: 2.2 }}>
                          <Typography
                            sx={{ color: '#172041', fontWeight: 800, fontSize: '1.02rem' }}
                          >
                            {
                              [
                  ...
                  {data.gallery?.[3]?.url ? (
                    ...
                    <Box
                      sx={{
                        width: '100%',
                        height: '100%',
                        background: 'linear-gradient(135deg, #eef1ff 0%, #dce4ff 100%)',
                      }}
                    />
                  )}
                </Box>
