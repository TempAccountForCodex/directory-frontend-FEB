          ...
          <FadeIn delay={0.08}>
            ...
            >
              ...
              >
                ...
                >
                  Clear reporting, tighter forecasts, and decision support that leadership can use
                  immediately.
                </Typography>
              </Box>
            </Box>
          ...
          <FadeIn>
            ...
            >
              ...
              >
                ...
                >
                  Finance advisory built for capital decisions, cleaner reporting, and measurable
                  outcomes.
                </Typography>
              </Box>
            </Box>
...
function MetricsStrip({ theme }: { theme: ReturnType<typeof buildPremiumTheme> }) {
  const metrics = [
...
function PremiumFooter({
  ...
  return (
    ...
    >
      ...
      />
      <Typography variant="caption" sx={{ color: theme.bodyColor, letterSpacing: 1 }}>
...
function ConsultingReferenceBody({ data }: { data: TemplateProps['data'] }) {
  ...
  return (
    <>
      <Box
        id="services"
        sx={{ px: { xs: 2.5, md: 4.5 }, py: { xs: 8, md: 10 }, bgcolor: '#ffffff' }}
      >
                ...
                <Grid item xs={12} sm={6} md={3} key={service.name}>
                  <FadeIn delay={index * 0.08}>
                    ...
                    >
                      ...
                      <Typography
                        sx={{ mt: 2, color: '#143230', fontWeight: 800, fontSize: '1.1rem' }}
                      >
                        {service.name}
                      </Typography>
                      <Typography sx={{ mt: 1.1, color: '#6c8482', lineHeight: 1.75 }}>
                        {service.description}
                      </Typography>
                    </Box>
                  </FadeIn>
                  ...
                  <Grid item xs={12} sm={5}>
                    <Stack spacing={2.2} sx={{ height: '100%' }}>
                      ...
                      <Box sx={{ p: 2.4, borderRadius: 4, bgcolor: '#0c5a59', color: '#eff8f6' }}>
                        ...
                        <Typography
                          sx={{ mt: 0.5, color: 'rgba(239,248,246,0.78)', lineHeight: 1.7 }}
                        >
        ...
        <Box sx={{ maxWidth: 1180, mx: 'auto' }}>
          <FadeIn>
            <Stack spacing={1.5} textAlign="center" alignItems="center">
              ...
              <Typography
                sx={{ color: '#163332', fontWeight: 800, fontSize: { xs: '2rem', md: '3rem' } }}
              >
              ...
              <Grid item xs={12} md={4} key={member.name}>
                <FadeIn delay={index * 0.08}>
                  ...
                  >
                    ...
                    <Box sx={{ p: 2.5 }}>
                      <Typography sx={{ color: '#153130', fontWeight: 800, fontSize: '1.12rem' }}>
                        {member.name}
                      </Typography>
                      <Typography
                        sx={{
                      ...
                      <Typography sx={{ mt: 1.2, color: '#6b8381', lineHeight: 1.75 }}>
                        {member.text}
                      </Typography>
                    </Box>
                  </Box>
            ...
            <Grid item xs={12} md={7}>
              <FadeIn>
                ...
                >
                  ...
                  <Typography
                    sx={{ mt: 2, color: 'rgba(239,248,246,0.76)', lineHeight: 1.85, maxWidth: 640 }}
                  >
                    We build finance systems leadership can actually use: board packs, planning
                    models, lender-ready narratives, and margin visibility that drives action.
                  </Typography>
      ...
      <Box
        id="contact"
        sx={{ px: { xs: 2.5, md: 4.5 }, py: { xs: 8, md: 10 }, bgcolor: '#083a39' }}
      >
        <Box sx={{ maxWidth: 1180, mx: 'auto' }}>
          <Grid container spacing={{ xs: 4, md: 5 }} alignItems="stretch">
            <Grid item xs={12} md={5}>
                ...
                <Stack spacing={1.4} sx={{ mt: 3 }}>
                  ...
                  {data.contact.address && (
                    <Stack direction="row" spacing={1.2} alignItems="flex-start">
                      ...
                      <Typography sx={{ color: 'rgba(244,250,248,0.82)', lineHeight: 1.7 }}>
                        {data.contact.address}
                      </Typography>
                    </Stack>
                  )}
