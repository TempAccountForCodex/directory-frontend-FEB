...
const CompanyPremiumTemplate: React.FC<TemplateProps> = ({ data }) => {
  ...
  const heroHeading =
    ...
    data.tagline ||
    "Beautiful presentation for modern brands.";
  const heroSubheading =
    homeContent.subheading || homeContent.heroDescription || data.description;
  const heroCtaText =
  ...
  const servicesBlockId =
    testimonialsContent.blockId || featuresContent.blockId;
        ...
        <FadeIn>
          <Typography
            ...
            sx={{
              ...
              lineHeight: 0.95,
              ...(testimonialsContent.headingStyle ||
        ...
        <FadeIn delay={0.08}>
          <Typography
            ...
            sx={{
              ...
              color: "rgba(20,20,20,0.68)",
              lineHeight: 1.85,
              ...(testimonialsContent.descriptionStyle ||
