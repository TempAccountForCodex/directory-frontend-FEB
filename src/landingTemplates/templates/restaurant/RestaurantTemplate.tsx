...
const RestaurantTemplate: React.FC<TemplateProps> = ({ data }) => {
  ...
  const heroBannerImage = data.heroBannerUrl || data.gallery?.[2]?.url || data.gallery?.[0]?.url;
    ...
    <Box sx={{ bgcolor: black, color: '#fff', fontFamily: bodyFont }}>
      ...
      >
        ...
        <FadeIn delay={0.08}>
          ...
          >
            Bold comfort food, warm atmosphere, and dishes built to leave a lasting impression at
            every table.
          </Typography>
        </FadeIn>
        <FadeIn delay={0.16}>
      ...
      <Box id="story" data-preview-section="Story" sx={{ bgcolor: black }}>
        <Container maxWidth="lg" sx={{ px: { xs: 2, md: 3 }, py: { xs: 7, md: 9 } }}>
          <Grid container spacing={0}>
            ...
            >
              ...
              <Stack spacing={2.6} sx={{ mt: 4.5, maxWidth: 360 }}>
                {['Our Mission', 'Our Vision', 'Our Promise'].map((title, index) => (
        ...
        <Container maxWidth="lg">
          <Grid container spacing={{ xs: 3, md: 5 }}>
            <Grid item xs={12} md={3}>
              <FadeIn>
                <Typography sx={{ fontFamily: serifFont, fontSize: '2rem' }}>Location</Typography>
              </FadeIn>
            </Grid>
            <Grid item xs={12} md={4.5}>
              <FadeIn delay={0.08}>
                <Typography sx={{ lineHeight: 1.85, color: 'rgba(255,255,255,0.82)' }}>
                  Find us in the heart of the city where warm interiors, open-grill cooking, and
                  late-evening energy come together in one memorable dining room.
                </Typography>
              </FadeIn>
            </Grid>
            <Grid item xs={12} md={4.5}>
      ...
      <Grid container sx={{ bgcolor: black }}>
        <Grid item xs={12} md={5}>
          ...
          >
            <FadeIn>
              <Typography sx={{ color: '#fff', lineHeight: 1.9, maxWidth: 320 }}>
                Enjoy 25% off our menu for a limited time because great burgers taste even better
                with a deal.
              </Typography>
            </FadeIn>
            <FadeIn delay={0.1}>
        ...
        <Container maxWidth="lg">
          <Grid container spacing={{ xs: 4, md: 5 }} alignItems="stretch">
            ...
            <Grid item xs={12} md={6}>
              ...
              <Stack spacing={2}>
                {['Full Name', 'Email Address', 'Phone', 'Date', 'Time', 'Message'].map(
                  (label, index) => (
      ...
      >
        <Container maxWidth="lg">
          <Grid container spacing={4}>
            <Grid item xs={12} md={3}>
              <FadeIn>
                <Typography sx={{ fontFamily: serifFont, fontSize: '1.8rem', mb: 1 }}>
                  B. Morgan
                </Typography>
                <Typography sx={{ color: 'rgba(255,255,255,0.76)', lineHeight: 1.8 }}>
                  Restaurant operator focused on bold flavor, honest hospitality, and a memorable
                  dining room.
                </Typography>
            ...
            <Grid item xs={12} md={3}>
              <FadeIn delay={0.08}>
                <Typography sx={{ color: cream, fontWeight: 700, mb: 1.2 }}>Say Hello</Typography>
                <Typography sx={{ color: 'rgba(255,255,255,0.8)', lineHeight: 1.8 }}>
                  {data.contact.address}
                </Typography>
                <Typography sx={{ color: 'rgba(255,255,255,0.8)', lineHeight: 1.8, mt: 1 }}>
                  {data.contact.phone}
                </Typography>
                <Typography sx={{ color: 'rgba(255,255,255,0.8)', lineHeight: 1.8 }}>
                  {data.contact.email}
