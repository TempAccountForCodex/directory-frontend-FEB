...
const LOCAL_DEMO_POSTS: BlogPost[] = [
  ...
  {
    id: 'blog-4',
    title: '2026 startup finance checklist for founders hiring their first team',
    description:
...
function getPosts(data: TemplateProps['data']): BlogPost[] {
  return data.blogPosts && data.blogPosts.length > 0 ? data.blogPosts : LOCAL_DEMO_POSTS;
}
    ...
    >
      ...
      >
        <FadeIn>
          ...
          >
            <Typography sx={{ fontSize: { xs: '1.6rem', md: '1.8rem' }, fontWeight: 800 }}>
              {brandTitle}
          ...
          <Box>
            ...
            <FadeIn delay={0.24}>
              <Stack direction="row" spacing={1.2} flexWrap="wrap" useFlexGap sx={{ mt: 2.5 }}>
                <Chip label={formatDate(heroPost?.publishedAt)} variant="outlined" />
                <Chip label={getReadTime(heroPost || posts[0])} variant="outlined" />
              </Stack>
            </FadeIn>
            <FadeIn delay={0.32}>
              <Button
          ...
          <>
            ...
            <DialogContent sx={{ p: { xs: 2.5, md: 3 } }}>
              <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap>
                ...
                <Chip label={formatDate(selectedPost.publishedAt)} variant="outlined" />
                <Chip label={selectedPost.author || 'Editorial Desk'} variant="outlined" />
              </Stack>
              <Typography
                sx={{
                  mt: 2,
              ...
              <Typography sx={{ mt: 1.4, color: 'rgba(17,17,17,0.68)', lineHeight: 1.8 }}>
                {selectedPost.description}
              </Typography>
              <Divider sx={{ my: 2.2 }} />
              <Typography sx={{ lineHeight: 1.9 }}>{selectedPost.content}</Typography>
            </DialogContent>
          </>
        ) : null}
      </Dialog>
