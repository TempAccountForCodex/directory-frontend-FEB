        ...
        <FadeIn>
          ...
          >
            <Stack direction="row" spacing={1.1} alignItems="center">
              ...
              />
              <Typography
                sx={{ fontSize: { xs: '1.2rem', md: '1.6rem' }, fontWeight: 900, color: primary }}
              >
                {data.name || 'Agrob'}
              </Typography>
            </Stack>
        ...
        <FadeIn delay={0.12}>
          ...
          >
            ...
            <Typography sx={{ maxWidth: 760, color: '#6b7280', lineHeight: 1.8, mb: 4 }}>
              ...
              stronger planning and clearer visibility across the season.
            </Typography>
              ...
              {trendingPosts.map((post, index) => (
                <FadeIn key={post.id || index} delay={0.04 * index}>
                  <Box>
                    ...
                    />
                    <Typography
                      sx={{ fontWeight: 700, fontSize: '1.28rem', lineHeight: 1.25, mb: 1.1 }}
                    >
                      {post.title}
                    </Typography>
                    <Typography
                      sx={{ color: '#6b7280', lineHeight: 1.75, fontSize: '0.95rem', mb: 1.5 }}
                    >
                      {post.description}
                    </Typography>
        ...
        <FadeIn delay={0.18}>
          ...
          >
            ...
            <Box sx={{ pt: { xs: 0, md: 7 } }}>
              ...
              >
                <Typography sx={{ color: primary, fontWeight: 800, mb: 1 }}>Newsletter</Typography>
                ...
                <Typography sx={{ color: '#6b7280', lineHeight: 1.75, mb: 2.2 }}>
                  Weekly notes on crop planning, operational discipline, and better agricultural
                  visibility.
                </Typography>
                <Box
                  sx={{
          ...
          >
            <FadeIn>
              <Box>
                ...
                <Typography
                  sx={{ color: 'rgba(255,255,255,0.72)', maxWidth: 280, lineHeight: 1.8, mb: 2 }}
                >
                  Your one-stop solution to practical insight, planning, and field-ready growth
                  ideas.
                </Typography>
        ...
        {selectedPost && (
          <>
            ...
            <DialogContent sx={{ px: { xs: 2.5, md: 4 }, py: { xs: 3, md: 4 } }}>
              ...
              <Typography
                sx={{ color: '#667085', lineHeight: 1.95, fontSize: { xs: '1rem', md: '1.02rem' } }}
              >
