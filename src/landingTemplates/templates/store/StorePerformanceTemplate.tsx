            ...
            <Container maxWidth="xl">
              <FadeIn direction="right" delay={0.06}>
                ...
                >
                  ...
                  Start your fitness journey today with our top-notch products.
                </Typography>
              </FadeIn>
        ...
        >
          <FadeIn>
            ...
            >
              ...
              >
                At {data.name}, we are dedicated to providing premium gym equipment for both home
                and commercial use. Our focus is to offer durable products and expert advice to help
          ...
          <FadeIn key={row.title} delay={index * 0.08}>
            <Box
              sx={{
                display: 'grid',
                gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' },
                borderBottom: index < productRows.length - 1 ? `1px solid ${gridLine}` : 'none',
              }}
            >
              <Box
                sx={{
        ...
        >
          <FadeIn>
            ...
            >
              ...
              <Typography
                sx={{ mt: 1.2, fontSize: { xs: '1.3rem', md: '1.8rem' }, fontWeight: 700 }}
              >
