...
const footerLinks = ['Privacy Policy', 'Accessibility', 'Shipping Policy', 'Terms & Conditions'];
...
const StoreFitTemplate: React.FC<TemplateProps> = ({ data }) => {
  ...
  const contactAddress = data.contact.address || '500 Terry Francine St. San Francisco, CA 94158';
    ...
    <Box sx={{ bgcolor: palette.paper, color: '#000', overflow: 'hidden' }}>
          ...
          >
            ...
            <FadeIn>
              <Typography
                sx={{
                  ...
                  fontWeight: 500,
                  fontSize: { xs: '4rem', sm: '5.5rem', md: '8rem', lg: '9rem' },
            ...
            >
              ...
              >
                ...
                >
                  Experience the perfect blend of style and performance with our exclusive
      ...
      >
        <Container maxWidth={false} sx={{ maxWidth: 1440, px: { xs: 2, md: 3 } }}>
          ...
          >
            <Box
              sx={{
                borderRight: { xs: 'none', md: `1px solid ${palette.lightLine}` },
                p: { xs: 2, md: 2.2 },
                display: 'grid',
                gap: 1.6,
                alignContent: 'start',
            ...
            >
              <Typography sx={{ fontSize: '0.72rem', color: palette.mutedDark }}>
                New Collection
              </Typography>
              <Typography sx={{ fontSize: '0.72rem', color: palette.mutedDark }}>Women</Typography>
              <Button
                sx={{
                  mt: 1.5,
                  justifySelf: 'start',
            ...
            >
              ...
              >
                Discover a new standard of movement with clean silhouettes, polished fabrics, and a
                modern performance attitude.
              </Typography>
            </Box>
      ...
      >
        <Container maxWidth={false} sx={{ maxWidth: 1440, px: { xs: 2, md: 3 } }}>
            ...
            {products.map((product) => (
              <FadeIn key={product.id}>
                <Box>
                  ...
                  <Typography
                    sx={{ mt: 1.5, textAlign: 'center', fontSize: { xs: '0.9rem', md: '1rem' } }}
                  >
                    {product.name}
                  </Typography>
                </Box>
          ...
          >
            Experience the perfect blend of style and performance with our exclusive activewear
            collection.
          </Typography>
        </Container>
      </Box>
      ...
      >
        <Container maxWidth={false} sx={{ maxWidth: 1440, px: { xs: 2, md: 3 } }}>
          ...
          >
            <Box sx={{ gridColumn: { md: '1 / span 3' }, display: 'grid', gap: 2 }}>
              <Box
                component="img"
                src={collageOne}
              ...
              <Box
                ...
                src={collageThree}
                alt="Editorial product detail"
                sx={{ ...smallImageStyles, width: { xs: '60%', md: '72%' }, ml: { md: 'auto' } }}
              />
            </Box>

            <Box sx={{ gridColumn: { md: '4 / span 6' }, textAlign: 'center', px: { md: 4 } }}>
              <FadeIn>
                <Typography
                  sx={{
                    fontSize: '0.72rem',
                ...
                >
                  Minimal lines, bright performance color, and a campaign-led product story inspired
                  directly by the reference layout.
                </Typography>
                <Button
                  sx={{
                    mt: 3,
              ...
              {stories.map((story) => (
                ...
                >
                  <Box
                    ...
                    src={story.image}
                    alt={story.title}
                    sx={{ width: 92, height: 120, objectFit: 'cover', display: 'block' }}
                  />
                  <Box>
                    <Typography
                      sx={{
      ...
      <Box data-preview-section="true" data-preview-label="Contact Split" sx={{ bgcolor: '#fff' }}>
        <Container maxWidth={false} sx={{ maxWidth: 1440, px: { xs: 0, md: 0 } }}>
          <Box
            sx={{
              display: 'grid',
            ...
            >
              <Box sx={{ width: '100%', maxWidth: 420, mx: 'auto' }}>
                ...
                <Stack spacing={1.5} sx={{ mt: 3 }}>
                  <TextField placeholder="Name" fullWidth size="small" sx={fieldStyles} />
                  <TextField placeholder="Email" fullWidth size="small" sx={fieldStyles} />
                  <TextField
                    placeholder="Message"
                    fullWidth
                    size="small"
      ...
      >
        <Container maxWidth={false} sx={{ maxWidth: 1440, px: { xs: 2, md: 3 } }}>
          ...
          >
            ...
            <Stack spacing={0.45} sx={{ alignItems: { xs: 'flex-start', md: 'flex-end' } }}>
          ...
          >
            <Typography sx={{ fontSize: '0.82rem', color: 'rgba(255,255,255,0.62)' }}>
