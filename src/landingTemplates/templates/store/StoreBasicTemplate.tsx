...
const StoreBasicTemplate: React.FC<TemplateProps> = ({ data }) => {
  ...
  const [sizes, setSizes] = useState<Record<string, string>>(
    Object.fromEntries(featuredProducts.map((product) => [product.id, 'Standard']))
  );
  ...
  const logoSrc = data.logoUrl || 'https://cdn-icons-png.freepik.com/128/1198/1198419.png';
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <textPath href="#store-basic-wave" startOffset="0%" method="align" spacing="auto">
                {tickerText}
              </textPath>
            </text>
          </Box>
      ...
      <Box id="about" sx={{ bgcolor: '#171312', color: '#f3efe9' }}>
        ...
        >
          ...
          <FadeIn delay={0.16}>
            <Box id="contact">
              <Typography sx={{ fontSize: '0.85rem', color: 'rgba(243,239,233,0.64)' }}>
                Newsletter
              </Typography>
              <Typography
                sx={{
              ...
              >
                Drop your email below for new launches, product updates, and campaign announcements.
              </Typography>
