...
import { AppBar, Toolbar, Typography, Box, Button, Stack, IconButton } from '@mui/material';
...
const fallbackLogo = 'https://img.freepik.com/free-vector/vector-education-logo_779267-2059.jpg';
...
function getHeaderConfig(data: TemplateProps['data'], theme: ModernThemeType): HeaderConfig {
