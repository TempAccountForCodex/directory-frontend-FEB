...
import { Box, Typography, Stack, IconButton, Button, Avatar, Divider } from '@mui/material';
            ...
            <Stack spacing={1}>
              {item.client && (
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                  <Typography
                    variant="caption"
                    sx={{ color: TEXT_DIMMER, textTransform: 'uppercase', letterSpacing: 1.5 }}
                  >
                    Client
                  </Typography>
              ...
              <Box sx={{ mt: 3, display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                {item.tags.map((t, i) => (
                  ...
                  >
                    <Typography
                      variant="caption"
                      sx={{ color: TEXT_DIM, fontSize: '0.65rem', letterSpacing: 1 }}
                    >
                      {t}
                    </Typography>
                  </Box>
...
const PortfolioAgencyTemplate: React.FC<TemplateProps> = ({ data }) => {
  ...
  return (
    <Box sx={{ fontFamily: "'Inter', sans-serif", bgcolor: BG, minHeight: '100vh', color: '#fff' }}>
      {lightboxItem && (
        <Lightbox item={lightboxItem} onClose={() => setLightboxItem(null)} accent={accent} />
      )}
              ...
              <FadeIn key={i} delay={i * 0.12}>
                ...
                >
                  ...
                  >
                    <Typography
                      variant="overline"
                      sx={{ color: accent, letterSpacing: 3, fontSize: '0.6rem' }}
                    >
      ...
      {listItems.length > 0 && (
        ...
        >
          <FadeIn>
            <Typography
              variant="overline"
              sx={{ color: accent, letterSpacing: 4, fontSize: '0.65rem', display: 'block', mb: 6 }}
            >
              All Work
            </Typography>
          </FadeIn>
              ...
              {services.slice(0, 6).map((s, i) => (
                <FadeIn key={i} delay={i * 0.07}>
                  ...
                  >
                    ...
                    {s.price && (
                      <Typography
                        sx={{ color: accent, fontWeight: 700, mt: 2, fontSize: '0.85rem' }}
                      >
                        {s.price}
                      </Typography>
                    )}
              ...
              <FadeIn key={i} delay={i * 0.1}>
                ...
                >
                  ...
                  <Box sx={{ p: { xs: 2.5, md: 3 } }}>
                    ...
                    {member.bio && (
                      <Typography
                        sx={{ mt: 1, color: TEXT_DIM, fontSize: '0.78rem', lineHeight: 1.65 }}
                      >
                        {member.bio}
                      </Typography>
                    )}
          ...
          <Box sx={{ maxWidth: 1400, mx: 'auto' }}>
            <FadeIn>
              ...
              >
                ...
                <Typography
                  sx={{ color: accent, fontWeight: 700, fontSize: '2.5rem', lineHeight: 1 }}
                >
                  "
                </Typography>
              </Box>
                  ...
                  >
                    ...
                    <Box sx={{ display: 'flex', gap: 0.5, mb: 3 }}>
                      {Array.from({ length: Math.round(r.rating || 5) }).map((_, si) => (
                        <Box key={si} sx={{ color: accent, fontSize: '0.9rem' }}>
                          ★
                        </Box>
                      ))}
                    </Box>
      ...
      >
        ...
        <FadeIn>
          <Typography
            variant="overline"
            sx={{ color: accent, letterSpacing: 4, fontSize: '0.65rem', display: 'block', mb: 3 }}
          >
            Get In Touch
          </Typography>
          <Typography
          ...
          >
            Have a project in mind? We'd love to hear about it. Let's create something remarkable
            together.
          </Typography>
