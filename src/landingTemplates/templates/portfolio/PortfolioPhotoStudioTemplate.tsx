...
import { ArrowUpRight, Camera, Instagram, Mail, Star, Twitter } from 'lucide-react';
...
const brandMarks = ['LOOK', 'FRAME', 'MUSE', 'AVENUE', 'PIXEL', 'LUXE', 'VOGUE', 'TONE'];
...
const TextReveal: React.FC<{ text: string; sx?: Record<string, unknown> }> = ({ text, sx }) => (
  <Box
  ...
  >
    {text.split(' ').map((word, index) => (
      ...
      >
        <Box component={motion.span} variants={textRevealWord} sx={{ display: 'inline-block' }}>
          {word}
        </Box>
      </Box>
    ))}
...
const PortfolioPhotoStudioTemplate: React.FC<TemplateProps> = ({ data }) => {
  ...
  const portfolioItems = useMemo(
    () =>
      (data.portfolioItems?.length ? data.portfolioItems : []).slice(0, 8).map((item, index) => ({
        ...item,
        image:
          item.image ||
          [
  ...
  const heroImage = data.heroBannerUrl || gallery[0]?.url || fallbackImages.hero;
  const recentWorkImage = portfolioItems[0]?.image || fallbackImages.collageThree;
        ...
        >
          ...
          >
            ...
            <Box sx={{ textAlign: { xs: 'left', md: 'right' } }}>
              <Typography sx={{ fontSize: { xs: '1rem', md: '1.05rem' } }}>Photographer</Typography>
              <Typography
                sx={{
                  mt: 0.3,
                  fontSize: { xs: '1rem', md: '1.05rem' },
            ...
            <Box sx={{ position: 'relative', minHeight: { md: 560 } }}>
              ...
              >
                ...
                >
                  ...
                  >
                    Capturing timeless moments that tell stories of emotion, beauty, and truth in
                    every frame and every pose.
                  </Typography>
                </Box>
              </Box>
          ...
          >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <textPath href="#photo-studio-contact-circle" startOffset="0%">
            ...
            >
              ...
              >
                ...
                >
                  Working with {data.name}, you get bold portrait direction, cinematic beauty
                  styling, and imagery built to feel striking, polished, and impossible to ignore.
                </Typography>
              </Box>
            </Box>
          </Box>
        ...
        <Container maxWidth="lg">
          ...
          >
            <Box>
              ...
              >
                We are a fashion-focused creative studio dedicated to delivering refined
                photography, visual direction, and bold portrait stories with a polished editorial
                finish.
              </Typography>
            ...
            <Box>
              ...
              >
                Specializing in high-end fashion photography and model development through
                concept-driven visual storytelling. We build imagery with clarity, discipline, and a
                carefully curated creative process.
              </Typography>
            ...
            >
              <FadeIn delay={0.02} direction="up">
                ...
                >
                  <Box
                    component="img"
                    src={portfolioItems[0]?.image || fallbackImages.collageThree}
              ...
              <Box sx={{ display: 'grid', gap: 2 }}>
                {[
                  {
                    image: portfolioItems[1]?.image || fallbackImages.collageOne,
                  ...
                  <FadeIn key={item.image + item.title} delay={0.1 + index * 0.08} direction="up">
                    <Box
                      sx={{
                        position: 'relative',
                        overflow: 'hidden',
              ...
              <Box sx={{ display: 'grid', gap: 2 }}>
                {[
                  {
                    image: portfolioItems[3]?.image || fallbackImages.collageFour,
                  ...
                  <FadeIn key={item.image + item.title} delay={0.18 + index * 0.08} direction="up">
                    <Box
                      sx={{
                        position: 'relative',
                        overflow: 'hidden',
              ...
              <FadeIn direction="up">
                <Box>
                  ...
                  >
                    ...
                    >
                      Share your concept, timeline, and the kind of visuals you want to create.
                      We&apos;ll shape the right direction for the shoot.
                    </Typography>
                  </Box>
              ...
              <FadeIn direction="up" delay={0.08}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      We usually reply within one business day with availability, direction, and
                      next steps.
                    </Typography>
                    <Button
                      type="submit"
              ...
              {socialLinks.map((item) => {
                ...
                return (
                  <Box
                    key={item.key}
                    component="a"
                    href={data.socialLinks?.[item.key as keyof typeof data.socialLinks] || '#'}
                    target="_blank"
                    rel="noreferrer"
