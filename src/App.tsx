...
const WebsiteEditor = lazy(() => import('./components/Dashboard/WebsiteEditor'));
import GoogleAnalyticsTracker from './utils/commons/GoogleAnalyticsTracker';
const TermsConditions = lazy(() => import('../src/pages/publicPages/TermsConditions'));
...
const CookieBanner = lazy(() => import('./components/UserPreferences/PreferenceBanner.jsx'));
const CookiePreferences = lazy(() => import('./components/UserPreferences/PreferenceSettings.jsx'));
...
const AppRoutes = () => {
  const suspense = (element: React.ReactNode) => <Suspense fallback={null}>{element}</Suspense>;
