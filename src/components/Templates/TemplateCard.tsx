...
import { Box, Card, CardContent, CardActions, Chip, Typography, Button } from '@mui/material';
import {
  Eye,
  LayoutTemplate,
  Building2,
...
> = {
  ...
  ecommerce: { bg: 'rgba(236,72,153,0.1)', accent: '#EC4899', Icon: ShoppingBag },
  restaurant: { bg: 'rgba(239,68,68,0.1)', accent: '#EF4444', Icon: UtensilsCrossed },
  ...
  education: { bg: 'rgba(6,182,212,0.1)', accent: '#06B6D4', Icon: GraduationCap },
  saas: { bg: 'rgba(55,140,146,0.1)', accent: '#378C92', Icon: Layers },
  'landing-page': { bg: 'rgba(34,197,94,0.1)', accent: '#22C55E', Icon: Rocket },
};
...
const TemplateCard = React.memo(function TemplateCard({
  ...
  const showPlaceholder =
    !template.previewImage || !isSafePreviewUrl(template.previewImage) || imgError;
      ...
      <Box sx={{ position: 'relative' }}>
        {!showPlaceholder ? (
          ...
          >
            ...
            {(template.pageCount !== undefined || template.blockCount !== undefined) && (
              <Box sx={{ display: 'flex', gap: 0.5, flexWrap: 'wrap', justifyContent: 'center' }}>
                ...
                {template.blockCount !== undefined && template.blockCount > 0 && (
                  <Chip
