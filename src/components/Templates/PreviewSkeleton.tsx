...
export const PreviewCardSkeleton = React.memo(function PreviewCardSkeleton() {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ p: 2 }}>
        <Skeleton variant="rounded" width={70} height={22} sx={{ mb: 1, borderRadius: '11px' }} />
...
export const PreviewTimeoutWarning = React.memo(function PreviewTimeoutWarning({
  ...
  return (
    <Alert severity="warning" icon={<AlertTriangle size={18} />} sx={{ mt: 1 }}>
      Preview is taking longer than expected. This may be due to a slow connection.
    </Alert>
  );
});
...
export function usePreviewTimeout(loading: boolean, timeoutMs: number = 5000): boolean {
