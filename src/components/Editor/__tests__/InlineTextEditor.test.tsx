...
describe('InlineTextEditor', () => {
  ...
  it('validation: shows error on maxLength violation', async () => {
    ...
    render(<InlineTextEditor {...defaultProps} initialValue={longValue} maxLength={100} />);
  ...
  it('is wrapped with React.memo', () => {
    ...
    expect((InlineTextEditor as unknown as { $$typeof: symbol }).$$typeof).toBe(memoSymbol);
  });
  ...
  it('handles null/undefined edge cases', () => {
    render(<InlineTextEditor {...defaultProps} initialValue={undefined as unknown as string} />);
    const editor = screen.getByRole('textbox');
    expect(editor).toBeInTheDocument();
  });
});
