...
const FRONTEND_BLOCKS: BlockLibraryItem[] = [
  ...
  },
  {
    key: "BLOG_HERO",
    label: "Blog Hero",
    description: "Bold gradient hero header for your blog index page",
    category: "content",
    icon: "article",
    capabilities: {
      supportsBackground: false,
    ...
    variants: [],
    searchKeywords: ["blog", "hero", "header", "insights", "articles", "banner"],
  },
  {
    key: "BLOG_FEATURED",
    label: "Featured Article",
    description: "Highlight one blog post in a large featured card",
    category: "dynamic",
    icon: "article",
    capabilities: {
      supportsBackground: false,
    ...
    variants: [],
    searchKeywords: ["blog", "featured", "article", "post", "highlight"],
  },
  {
    key: "BLOG_GRID",
    label: "Blog Grid",
    description: "Searchable, filterable grid of your blog posts",
    category: "dynamic",
    icon: "grid_view",
    capabilities: {
      supportsBackground: false,
