...
const RecoveryModal: React.FC<RecoveryModalProps> = memo(function RecoveryModal({
  open,
  timestamp,
  onRestore,
  onDiscard,
    ...
    >
      ...
      <DialogContent>
        <Typography variant="body1" sx={{ mb: 2 }}>
          You have unsaved changes from <strong>{formatTimeAgo(timestamp)}</strong>. Would you like
          to restore them?
        </Typography>

        <Typography variant="body2" color="text.secondary">
          If you don&apos;t respond within 30 seconds, changes will be discarded automatically.
        </Typography>
