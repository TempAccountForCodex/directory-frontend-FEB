...
const defaultHours = [
  { day: 'Monday' as const, openTime: '09:00', closeTime: '18:00', isClosed: false },
  { day: 'Tuesday' as const, openTime: '09:00', closeTime: '18:00', isClosed: false },
  { day: 'Wednesday' as const, openTime: '09:00', closeTime: '18:00', isClosed: false },
  { day: 'Thursday' as const, openTime: '09:00', closeTime: '18:00', isClosed: false },
  { day: 'Friday' as const, openTime: '09:00', closeTime: '17:00', isClosed: false },
  { day: 'Saturday' as const, openTime: '10:00', closeTime: '15:00', isClosed: false },
  { day: 'Sunday' as const, openTime: '', closeTime: '', isClosed: true },
];

const makeBlock = (overrides: Record<string, unknown> = {}, variant?: string) => ({
  id: 1,
...
describe('WorkingHoursBlock', () => {
  ...
  it('closed days use muted secondary text style', () => {
    const { container } = render(<WorkingHoursBlock block={makeBlock()} primaryColor="#2563eb" />);
  ...
  it('showCurrentStatus=false hides the status badge (no Chip)', () => {
    render(
      <WorkingHoursBlock block={makeBlock({ showCurrentStatus: false })} primaryColor="#2563eb" />
    );
  ...
  it('showCurrentStatus=true renders Open Now chip (Monday 10 AM)', () => {
    ...
    render(
      <WorkingHoursBlock block={makeBlock({ showCurrentStatus: true })} primaryColor="#2563eb" />
    );
  ...
  it('compact variant renders a Card element', () => {
    const { container } = render(
      <WorkingHoursBlock block={makeBlock({}, 'compact')} primaryColor="#2563eb" />
    );
  ...
  it('renders gracefully with empty hours array', () => {
    const { container } = render(
      <WorkingHoursBlock block={makeBlock({ hours: [] })} primaryColor="#2563eb" />
    );
  ...
  it('renders without heading when heading is omitted', () => {
    render(<WorkingHoursBlock block={makeBlock({ heading: '' })} primaryColor="#2563eb" />);
