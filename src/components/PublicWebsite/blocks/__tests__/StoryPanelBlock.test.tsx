...
describe('StoryPanelBlock', () => {
  ...
  it('renders without heading when none provided', () => {
    render(<StoryPanelBlock content={{ ...baseContent, heading: undefined }} />);
  ...
  it('renders top-bottom layout when variant is set', () => {
    render(<StoryPanelBlock content={{ ...baseContent, variant: 'top-bottom' }} />);
  ...
  it('auto-rotates to next story after interval', () => {
    render(
      <StoryPanelBlock content={{ ...baseContent, autoRotate: true, autoRotateInterval: 3000 }} />
    );
  ...
  it('clamps to max 6 stories', () => {
    ...
    render(<StoryPanelBlock content={{ ...baseContent, stories: manyStories }} />);
    const tabs = screen.getAllByRole('tab');
