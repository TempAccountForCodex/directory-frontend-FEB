...
import EmbedBlock, { getAllowedDomain, getPlatformName, ALLOWED_DOMAINS } from '../EmbedBlock';
...
describe('EmbedBlock', () => {
  ...
  it('renders heading when provided', () => {
    render(<EmbedBlock block={makeBlock({ heading: 'Book a Meeting', url: '' })} />);
  ...
  it('getAllowedDomain returns domain for calendly.com URL', () => {
    expect(getAllowedDomain('https://calendly.com/user/meeting')).toBe('calendly.com');
  });

  it('getAllowedDomain returns domain for docs.google.com URL', () => {
    expect(getAllowedDomain('https://docs.google.com/document/d/abc123/edit')).toBe(
      'docs.google.com'
    );
  });
  ...
  it('getAllowedDomain handles subdomain match (app.calendly.com)', () => {
    expect(getAllowedDomain('https://app.calendly.com/user/meeting')).toBe('calendly.com');
  });
