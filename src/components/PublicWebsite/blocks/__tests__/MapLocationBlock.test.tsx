...
describe('MapLocationBlock', () => {
  ...
  it('renders without heading when heading not provided', () => {
    const { container } = render(<MapLocationBlock block={makeBlock({ heading: '' })} />);
  ...
  it('renders SVG circle for each of multiple markers', () => {
    ...
    const { container } = render(<MapLocationBlock block={makeBlock({ markers })} />);
    const circles = container.querySelectorAll('circle');
  ...
  it('renders with framer motion animation wrapper', () => {
    ...
    const motionEl = screen.queryByTestId('motion-div') || screen.queryByTestId('motion-section');
  ...
  it('renders circle with marker color as fill', () => {
    ...
    const { container } = render(<MapLocationBlock block={makeBlock({ markers: [marker] })} />);
  ...
  it('renders without errors with style=region', () => {
    expect(() => render(<MapLocationBlock block={makeBlock({ style: 'region' })} />)).not.toThrow();
  });
});
