...
describe('FooterBlock', () => {
  ...
  it('newsletter section renders when showNewsletter=true', () => {
    renderBlock({ showNewsletter: true, newsletterHeading: 'Stay in the loop' });
  ...
  it('newsletter section hidden when showNewsletter=false', () => {
    renderBlock({ showNewsletter: false, newsletterHeading: 'Stay in the loop' });
  ...
  it('newsletter email input renders with placeholder', () => {
    renderBlock({ showNewsletter: true, newsletterPlaceholder: 'your@email.com' });
