/**
 * NavbarBlock — PublicWebsite Renderer (Step 14.10)
 *
 * Renders a global navbar for the live public website.
 * Copy of the preview NavbarBlock with:
 *   - BlockWrapper integration for design token support
 *   - MUI icons (Menu / Close) for mobile hamburger
 *   - Dynamic height measurement via ResizeObserver
 *   - Scroll shadow polish (transparent + solid sticky variants)
 *
 * Accepts {content} props from BlockWrapper-compatible block shape.
...
interface NavbarContent {
  ...
  variant?: unknown;
  // BlockWrapper design fields (passed through)
  [key: string]: unknown;
}
