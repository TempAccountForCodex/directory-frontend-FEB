...
describe('DynamicBlockRenderer', () => {
  ...
  it('renders BlockRenderer directly for static blocks (passthrough)', () => {
    render(
      <Wrapper>
        <DynamicBlockRenderer block={staticBlock} primaryColor="#378C92" secondaryColor="#D3EB63" />
      </Wrapper>
    );
  ...
  it('passes primaryColor and secondaryColor to BlockRenderer', () => {
    render(
      <Wrapper>
        <DynamicBlockRenderer block={staticBlock} primaryColor="#ff0000" secondaryColor="#00ff00" />
      </Wrapper>
    );
    expect(screen.getByTestId('block-renderer')).toBeInTheDocument();
  });
  ...
  it('passes headingColor and bodyColor to BlockRenderer', () => {
    render(
      <Wrapper>
        <DynamicBlockRenderer block={staticBlock} headingColor="#111111" bodyColor="#333333" />
      </Wrapper>
    );
    expect(screen.getByTestId('block-renderer')).toBeInTheDocument();
  });
  ...
  it('renders without error for multiple static blocks', () => {
    render(
      <Wrapper>
        <DynamicBlockRenderer block={staticBlock} />
        <DynamicBlockRenderer block={{ ...staticBlock, id: 99, blockType: 'TEXT' }} />
      </Wrapper>
    );
