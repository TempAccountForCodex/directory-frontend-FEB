...
const allFieldTypesBlock = {
  ...
  content: {
    ...baseBlock.content,
    fields: [
      { name: 'txt', label: 'Text', type: 'text' as const, required: false, validation: {} },
      { name: 'eml', label: 'Email', type: 'email' as const, required: false, validation: {} },
      { name: 'phn', label: 'Phone', type: 'phone' as const, required: false, validation: {} },
      {
        name: 'msg',
        label: 'Message',
      ...
      { name: 'fil', label: 'File', type: 'file' as const, required: false, validation: {} },
      {
        name: 'chk',
        label: 'Agree',
      ...
      { name: 'dt', label: 'Date', type: 'date' as const, required: false, validation: {} },
      { name: 'num', label: 'Number', type: 'number' as const, required: false, validation: {} },
      { name: 'url', label: 'URL', type: 'url' as const, required: false, validation: {} },
    ],
  },
};
...
describe('FormBuilderBlock', () => {
  ...
  it('is wrapped with React.memo (has displayName)', () => {
    ...
    const name = (FormBuilderBlock as any).displayName || (FormBuilderBlock as any).type?.name;
...
describe('FormBuilderBlock - Cascading Select', () => {
  ...
  it('selecting parent enables child select', async () => {
    ...
    const childNativeInput = document.querySelector('input[name="category_sub"]');
    ...
    await waitFor(() => {
      const updatedChildNativeInput = document.querySelector('input[name="category_sub"]');
