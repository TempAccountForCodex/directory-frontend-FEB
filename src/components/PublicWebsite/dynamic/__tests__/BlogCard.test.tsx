...
const baseMockPost = {
  ...
  category: 'Technology',
  description: 'This is the excerpt for the test blog post, it is longer than expected.',
...
describe('BlogCard', () => {
  it('renders post title always', () => {
    render(<BlogCard post={baseMockPost} config={baseConfig} colors={baseColors} />);
  ...
  it('renders placeholder when post has no image and showImage=true', () => {
    ...
    expect(container.querySelector('[data-testid="blog-card-image-placeholder"]')).not.toBeNull();
  });
  ...
  it('fires onClick when card is clicked', () => {
    ...
    render(
      <BlogCard post={baseMockPost} config={baseConfig} colors={baseColors} onClick={handleClick} />
    );
  ...
  it('is wrapped in React.memo', () => {
    ...
    rerender(<BlogCard post={baseMockPost} config={baseConfig} colors={baseColors} />);
    expect(container.firstChild).not.toBeNull();
  });
  ...
  it('handles missing author gracefully', () => {
    render(
      <BlogCard post={{ ...baseMockPost, author: null }} config={baseConfig} colors={baseColors} />
    );
    expect(screen.getByText('Test Blog Post Title')).toBeInTheDocument();
  });
});
