...
const DrawerItems: React.FC<DrawerItemsProps> = ({ tab, handleDrawerToggle }) => {
  ...
  const finalTab: NavItem[] = auth.user ? [...tab, ...logoutTab] : [...tab, ...drawerTab];
          ...
          return (
            <ListItem
              ...
              sx={{
                ...
                backgroundColor: isActive ? 'rgb(255 255 255 / .06)' : 'inherit',
