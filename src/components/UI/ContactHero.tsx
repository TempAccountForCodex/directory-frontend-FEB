...
const TypewriterText: React.FC<TypewriterTextProps> = ({ text, delay = 100, typographyProps }) => {
          ...
          <Grid item xs={12} lg={6} sx={{ pl: { xs: 0, lg: 5 } }}>
            ...
            >
              ...
              <motion.div variants={itemVariants}>
                ...
                >
                  Have a question, need support, or want to start a project? Our team is here to
                  help reach out by form, email, or phone.
                </Typography>
              </motion.div>
              ...
              >
                <motion.div variants={buttonVariants}>
                  <Button
                    onClick={(e) => handleScrollToSection(e, '#CONTACT_CARD_ID')}
