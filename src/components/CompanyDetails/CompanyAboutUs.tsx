...
const CompanyContactCrd: React.FC<CompanyContactCrdProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        Welcome to {title}, where we are dedicated to delivering excellence and innovation in
        everything we do. We have built a reputation for providing top-quality products and services
