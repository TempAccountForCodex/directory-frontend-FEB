...
function renderBlockSelector(overrides: Partial<ReturnType<typeof defaultProps>> = {}) {
...
describe('BlockSelector — block type listing', () => {
  ...
  it('shows description for each block type', () => {
    ...
    expect(screen.getByText('Large headline section with CTA')).toBeInTheDocument();
    expect(
