...
describe('BottomSheet', () => {
  ...
  it('renders with initialSnap=2 when specified', () => {
    const { container } = render(<BottomSheet {...defaultProps} initialSnap={2} />);
    const paper = container.querySelector('.MuiDrawer-paper');
    if (paper) {
  ...
  it('renders with initialSnap=0 when specified', () => {
    const { container } = render(<BottomSheet {...defaultProps} initialSnap={0} />);
    const paper = container.querySelector('.MuiDrawer-paper');
    if (paper) {
  ...
  it('applies custom sx overrides to Paper', () => {
    const { container } = render(<BottomSheet {...defaultProps} sx={{ maxWidth: '500px' }} />);
