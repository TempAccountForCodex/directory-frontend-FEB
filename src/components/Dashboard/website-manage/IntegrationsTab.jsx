    ...
    case "GOOGLE_ANALYTICS":
      return (
        <DashboardInput
          ...
          helperText={
            errors.measurementId || "Found in GA4 → Admin → Data Streams → Web"
          }
    ...
    case "FACEBOOK_PIXEL":
      return (
        <DashboardInput
          ...
          helperText={
            errors.pixelId || "Found in Facebook Events Manager → Pixels"
          }
          inputProps={{
    ...
    case "GOOGLE_TAG_MANAGER":
      return (
        <DashboardInput
          ...
          helperText={
            errors.containerId || "Found in GTM → Admin → Container Settings"
          }
    ...
    case "HOTJAR":
      return (
        <DashboardInput
          ...
          helperText={
            errors.siteId ||
            "Found in Hotjar → Settings → Sites & Organizations"
          }
    ...
    case "INTERCOM":
      return (
        <DashboardInput
          ...
          error={!!errors.appId}
          helperText={
            errors.appId || "Found in Intercom → Settings → Installation → Web"
          }
        ...
        <Box display="flex" flexDirection="column" gap={2}>
          <DashboardInput
            ...
            helperText={
              ...
              "Add HTML, CSS, or JavaScript. Raw JS runs automatically; you can also use <script> tags."
            }
            multiline
            minRows={4}
            maxRows={10}
          ...
          <DashboardSelect
            ...
            helperText={
              errors.position || "Where the snippet is injected in the page"
            }
...
const IntegrationCard = memo(({ integration, onToggle, onEdit, onDelete }) => {
  ...
  const typeInfo = useMemo(
    () => getTypeInfo(integration.integrationType),
    ...
    >
      ...
      <Box display="flex" alignItems="center" gap={1.5}>
        <Box
          ...
          aria-hidden="true"
        >
          <Icon size={22} color={colors.panelMuted} />
        </Box>
      ...
      <Box
        ...
        sx={{
          pt: 0.5,
          borderTop: `1px solid ${alpha(colors.panelBorder, 0.5)}`,
        }}
      >
        {/* Toggle switch */}
        <FormControlLabel
        ...
        <Box display="flex" gap={0.5}>
          <DashboardIconButton
            ...
            sx={{
              ...
              borderColor: alpha(colors.panelBorder, 0.9),
              boxShadow: "none",
              "&:hover": {
                maxWidth: 44,
                px: 0,
          ...
          <DashboardIconButton
            ...
            sx={{
              ...
              borderColor: alpha(colors.panelDanger, 0.35),
              boxShadow: "none",
              "&:hover": {
                maxWidth: 44,
                px: 0,
                bgcolor: alpha(colors.panelDanger, 0.08),
                color: colors.panelDanger,
                borderColor: colors.panelDanger,
                boxShadow: "none",
              },
            }}
          />
...
const IntegrationsTab = memo(({ website, websiteId }) => {
    ...
    try {
      if (dialogMode === "edit" && editingIntegration) {
        ...
        await apiClient.post(
          baseUrl,
          { integrationType: selectedType, config },
          { withCredentials: true },
        );
  ...
  const handleDeleteConfirm = useCallback(async () => {
    ...
    setDeleting(true);
    try {
      await apiClient.delete(`${baseUrl}/${deleteTarget.id}`, {
        withCredentials: true,
      });
  ...
  const deleteTargetLabel = deleteTarget
    ? getTypeInfo(deleteTarget.integrationType).label
    : "";
