 ...
 *
 * Fork of CategoryManagement.jsx for the Website Blog Dashboard.
 * Step 2.24A.2 — Website Blog Category Management
 *
 * Uses platform-wide categories (same API endpoints as CategoryManagement).
 * Primary change: component renamed to WebsiteCategoryManagement.
 */
...
const WebsiteCategoryManagement = ({ user, searchQuery = '', addTrigger = 0 }) => {
  ...
  return (
    <Box>
      ...
      >
        <DashboardDataGrid
          gridId="website-category-management"
          rowData={categories}
      ...
      >
        ...
        <DialogContent>
          ...
          <Alert severity="warning" sx={{ mt: 2 }}>
            Make sure no blog posts are using this category before deleting.
          </Alert>
        </DialogContent>
        <DialogActions sx={{ p: 2, borderTop: `1px solid ${colors.border}` }}>
          <Button
