...
export default function AboutUsHeroScroll() {
  ...
  const visibleColumns = isMobile ? columns.slice(centerIndex - 1, centerIndex + 2) : columns;
    ...
    >
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            We’re creating simple tools that give businesses full control, visibility, and ownership
