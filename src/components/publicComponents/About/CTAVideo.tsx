  ...
  return (
    ...
    >
      <Container maxWidth="lg" sx={{ zIndex: 9, position: 'relative' }}>
        {/* ================= HEADER SECTION ================= */}
        <Grid container spacing={4} sx={{ mb: { xs: 6, md: 8 } }} alignItems="flex-start">
          ...
          <Grid item xs={12} md={5}>
            <Stack spacing={3}>
              ...
              >
                We remove technical barriers so you can focus on growth. Get a professional landing
                page and built-in directory visibility instantly and for free.
              </Typography>
              <Stack direction="row" spacing={2}>
                <Button
                  variant="contained"
                  sx={{
                    background: 'linear-gradient(135deg, #378C92 0%, #010202 100%)',
                    borderRadius: '50px',
                    px: 4,
                    py: 1.5,
                    textTransform: 'none',
            ...
            {[
              ...
              <Grid item xs={6} md={3} key={index}>
                <Stack
                  ...
                  sx={{
                    borderRight: {
                      md: index !== 3 ? `1px solid ${alpha('#000', 0.05)}` : 'none',
                    },
                  }}
                >
                  <Typography
