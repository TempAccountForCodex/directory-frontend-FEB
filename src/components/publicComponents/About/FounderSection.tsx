  ...
  return (
    <SectionWrapper>
      ...
      <Box textAlign="center" sx={{ zIndex: 1 }}>
        <Typography variant="h6" sx={{ fontWeight: 700, mb: 1, letterSpacing: '1px' }}>
          Hey, BUSINESS OWNER! 🏢
        </Typography>
        <Typography
          variant="h2"
      ...
      >
        ...
        <ModernCard sx={{ top: '15%', right: '5%', '--rotation': '4deg' }}>
          ...
          >
            Hiring designers and developers <Highlight>drains your budget</Highlight> before you
            launch
          </Typography>
        </ModernCard>
        ...
        <ModernCard sx={{ bottom: '25%', left: '2%', '--rotation': '3deg' }}>
          ...
          >
            Managing hosting and technical updates is a <Highlight>constant headache</Highlight>
          </Typography>
        </ModernCard>
        ...
        <ModernCard sx={{ bottom: '20%', right: '2%', '--rotation': '-3deg' }}>
          ...
          >
            Even with a site, <Highlight>getting discovered</Highlight> by customers remains a
            struggle
          </Typography>
        </ModernCard>
      ...
      >
        <Typography variant="body1" sx={{ opacity: 0.9, fontSize: '1.2rem', mb: 3 }}>
          We’re building a <b>simple platform</b> for businesses that want a professional online
          presence
          <b> without complexity, cost, or technical effort</b>. Get your free landing page and
