        ...
        <Grid container spacing={6} alignItems="center">
          ...
          <Grid item xs={12} md={6}>
            <Stack spacing={2}>
              ...
              >
                Most platforms give you more tools. We give you more <b>time</b>. We built this
                because business owners shouldn't need a computer science degree to sell locally.
              </Typography>
            </Stack>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              >
                ...
                >
                  The Friction{' '}
                  <Box component="span" sx={{ fontSize: '0.8rem', fontWeight: 500, opacity: 0.5 }}>
                    (Old Way)
                  </Box>
                </Typography>
                ...
                <Stack spacing={2} sx={{ mb: 4 }}>
                  {frictions.map((item, idx) => (
                    ...
                    >
                      ...
                      <Box sx={{ color: '#ef4444', display: 'flex' }}>{item.icon}</Box>
                    </Box>
                  ))}
                </Stack>
                ...
                >
                  ...
                  <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 2 }}>
                    <AutoAwesomeIcon sx={{ color: '#ffffffff', fontSize: '1.2rem' }} />
                    <Typography
                      variant="overline"
                      sx={{
                        fontWeight: 800,
                  ...
                  <Typography sx={{ opacity: 0.7, fontSize: '0.95rem' }}>
                    A high-converting landing page and directory listing, live in minutes, managed
                    by you.
                  </Typography>
                </Box>
              </Box>
