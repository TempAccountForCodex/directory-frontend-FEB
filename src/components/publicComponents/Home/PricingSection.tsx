          ...
          <Grid item xs={12} md={5}>
            ...
            >
              ...
              <Typography variant="h3" sx={{ fontWeight: 900, mb: 4 }}>
                $0{' '}
                <Box component="span" sx={{ fontSize: '1rem', opacity: 0.4, fontWeight: 500 }}>
                  / Always Free
                </Box>
              </Typography>
              ...
              <Stack spacing={2.5} sx={{ flexGrow: 1, mb: 5 }}>
                {[
                  ...
                  <Stack key={feature} direction="row" spacing={2} alignItems="center">
                    <VerifiedIcon sx={{ color: 'rgba(255, 255, 255, 0.95)', fontSize: 20 }} />
                    <Typography sx={{ fontWeight: 500, fontSize: '0.95rem' }}>{feature}</Typography>
                  </Stack>
                ))}
              </Stack>
                  ...
                  <Grid item xs={12} sm={6.5}>
                    <Chip
                      ...
                      sx={{
                        ...
                        fontSize: '0.65rem',
                        letterSpacing: 1,
                        background: 'linear-gradient(90deg, #378C92, #22111100)',
                        color: 'white',
                      }}
                    />
                    ...
                    >
                      Unlock unlimited creation, premium visibility, and powerful AI tools to scale
                      faster.
                    </Typography>
