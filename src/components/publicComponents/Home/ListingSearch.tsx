...
import { Box, Container, Typography, Stack, Grid, Paper, Chip, Avatar } from '@mui/material';
    ...
    >
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
        <Grid container spacing={4} alignItems="center">
              ...
              <Box>
                <Typography
                  ...
                  sx={{
                    ...
                    mb: 3,
                    '& span': {
                      background: 'linear-gradient(90deg, #fff 30%, #378C92 100%)',
                      WebkitBackgroundClip: 'text',
                      WebkitTextFillColor: 'transparent',
                    },
                  }}
                >
                  Search & Discover <ResponsiveBr hideFrom="lg" /> Local Businesses
                </Typography>
                ...
                >
                  The easiest way to find and connect with trusted local services in your area.
                </Typography>
                ...
                <Stack direction="row" spacing={2}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    ...
                    <Typography sx={{ color: '#fff', fontSize: '0.8rem', opacity: 0.7 }}>
                      +2k Users
                    </Typography>
                  </Box>
                </Stack>
          ...
          {/* RIGHT COLUMN */}
          <Grid item xs={12} lg={6}>
            <Stack spacing={2.5} sx={{ position: 'relative', mt: { xs: 10, lg: 0 } }}>
              ...
              >
                ...
                >
                  ...
                  >
                    Helping customers find the right business — while helping businesses get
                    discovered
                  </Typography>
                </Stack>
              </Paper>
                  ...
                  >
                    <Stack spacing={1}>
                      <Stack direction="row" spacing={0.5} justifyContent="center">
                        {[1, 2, 3, 4, 5].map((s) => (
                          <StarIcon key={s} sx={{ color: '#FFC107', fontSize: 14 }} />
                        ))}
                      </Stack>
                      <Typography
                        align="center"
