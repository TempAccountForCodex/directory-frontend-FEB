  ...
  return (
    ...
    >
      <Container maxWidth="lg">
            ...
            <Stack spacing={6}>
                ...
                <Grid item xs={12} sm={6}>
                  <Stack spacing={1}>
                    ...
                    >
                      ...
                      >
                        Get a high-converting <strong>Carrd-style website</strong> for your
                        business. No code, no cost, no hosting fees.
                      </Typography>
                    </Box>
                  </Stack>
                </Grid>
                  ...
                  >
                    ...
                    >
                      <Typography
                        ...
                        sx={{ color: 'rgba(255,255,255,0.7)', lineHeight: 1.6 }}
                      >
                        Automatic presence on our <strong>Global Directory</strong>. Be searchable
                        and discoverable by high-intent customers.
                      </Typography>
                    </Box>
                  </Stack>
                </Grid>
              ...
              >
                ...
                <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.6)' }}>
                  Manage your website and your directory listing in one place. No design skills
                  required—just your vision.
                </Typography>
              </Box>
            </Stack>
          </Grid>
          ...
          <Grid item xs={12} md={6} lg={7} sx={{ position: 'relative' }}>
            <Box
              sx={{
                ...
                width: '70%',
                height: '70%',
                background: 'radial-gradient(circle, rgba(46, 224, 154, 0.1) 0%, transparent 75%)',
                filter: 'blur(60px)',
                zIndex: 0,
              }}
            />
        ...
        >
          Everything you need to launch and scale your online presence, 100% free of charge.
        </Typography>
      </Container>
    </Box>
  );
