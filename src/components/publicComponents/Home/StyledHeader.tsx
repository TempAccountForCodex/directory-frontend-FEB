...
const heroImages = [Image, Image2, Image3, Image4, Image5, Image6, Image7, Image8];
...
const StyledHeader = styled(Grid)(({ theme }) => ({
  ...
  '&::after': {
    ...
    position: 'absolute',
    inset: 0,
    background: 'linear-gradient(to top right, rgba(0,0,0,0.4), rgba(55,140,146,0.05))',
...
const StyledHader: React.FC = () => {
  ...
  return (
    <Grid container component="div" sx={{ height: { xs: 'auto', md: '100vh' } }}>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Discover top rated local businesses from restaurants and nightlife to home services
                and professionals right in your neighborhood with our business listings.
              </Typography>
            </Box>
            <Button
