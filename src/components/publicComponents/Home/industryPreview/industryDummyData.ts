...
export const consultingData: BusinessData = {
  ...
  tagline: "Finance consulting for capital planning, performance improvement, and investor-ready growth.",
  description: "A boutique finance consulting firm helping founders, CFOs, and mid-market leadership teams strengthen forecasting, improve margins, prepare for transactions, and make capital decisions with confidence.",
  primaryColor: "#29354a",
  secondaryColor: "#c8a968",
  services: [
    { name: "CFO Advisory", description: "Ongoing strategic finance support for budgeting, board reporting, cash visibility, and executive decision-making.", price: "From $6,000" },
    { name: "FP&A and Forecasting", description: "Build rolling forecasts, driver-based models, and scenario plans that stand up to lender and investor scrutiny.", price: "From $7,500" },
    { name: "Transaction Readiness", description: "Prepare your financial story, diligence materials, and KPI narrative for fundraising, acquisition, or refinancing.", price: "From $9,000" },
    { name: "Cash Flow Optimization", description: "Improve working capital, reduce leakage, and create tighter control over operating cash performance.", price: "From $5,500" },
    { name: "Valuation Support", description: "Translate business performance into clear valuation logic for owners, investors, and strategic buyers.", price: "Custom" },
    { name: "Performance Dashboards", description: "Turn finance data into clear management dashboards focused on margin, runway, pipeline, and return metrics.", price: "From $4,200" },
  ],
  gallery: [
    { url: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=1400&q=80", caption: "Financial planning review" },
    { url: "https://images.unsplash.com/photo-1553729459-efe14ef6055d?auto=format&fit=crop&w=1200&q=80", caption: "Capital and cash analysis" },
    { url: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80", caption: "Performance dashboard strategy" },
    { url: "https://images.unsplash.com/photo-1559526324-593bc073d938?auto=format&fit=crop&w=1200&q=80", caption: "Board-level finance discussion" },
    { url: "https://images.unsplash.com/photo-1520607162513-77705c0f0d4a?auto=format&fit=crop&w=1200&q=80", caption: "Advisory meeting" },
    { url: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=1200&q=80", caption: "Financial model review" },
  ],
  reviews: [
    { author: "David L., CEO", rating: 5, text: "Meridian brought real financial discipline into our growth plan. Their forecasting model changed how we manage cash, hiring, and expansion.", date: "Feb 2026" },
    { author: "Jessica W., COO", rating: 5, text: "They translated messy reporting into a clean operating dashboard our leadership team actually uses every week. The visibility has been a major upgrade.", date: "Jan 2026" },
    { author: "Robert K., CFO", rating: 5, text: "From lender conversations to board materials, the team was precise, commercially sharp, and deeply credible on the finance side.", date: "Dec 2025" },
  ],
  contact: {
    phone: "(555) 740-9900",
