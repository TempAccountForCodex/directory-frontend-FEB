...
export const educationData: BusinessData = {
  ...
  logoUrl: 'https://img.freepik.com/free-vector/vector-education-logo_779267-2059.jpg',
  services: [
    {
...
export const gardeningData: BusinessData = {
  ...
  logoUrl: 'https://img.freepik.com/free-vector/home-leaf-logo-design-template_474888-4559.jpg',
  services: [
    {
      name: 'Garden Design',
      description: 'Custom landscape plans tailored to your property and lifestyle.',
      price: 'From $350',
    },
    {
      name: 'Lawn Care & Maintenance',
      description: 'Regular mowing, edging, fertilization, and seasonal cleanup.',
      price: 'From $80/visit',
    },
    {
      name: 'Planting & Mulching',
      description: 'Seasonal planting, bed edging, and premium mulch installation.',
      price: 'From $200',
    },
    {
      name: 'Irrigation Systems',
      description: 'Smart sprinkler installation and water-efficient drip systems.',
      price: 'From $1,200',
    },
    {
    ...
    {
      name: 'Hardscaping',
      description: 'Patios, walkways, retaining walls, and outdoor living areas.',
      price: 'From $2,500',
    },
  ],
  gallery: [
...
export const restaurantData: BusinessData = {
  ...
  logoUrl: 'https://img.freepik.com/free-vector/restaurant-logo-template_23-2149493636.jpg',
  heroBannerUrl:
  ...
  services: [
    {
      ...
      description: 'Intimate, candlelit dining in our beautifully appointed restaurant.',
      price: 'Avg $45/person',
    },
    {
      name: 'Private Events',
      description: 'Exclusive dining room for birthdays, anniversaries, and corporate events.',
      price: 'From $800',
    },
    {
    ...
    },
    {
      ...
      description: 'Monthly curated tasting menus with sommelier-selected Italian wines.',
      price: '$120/person',
    },
    {
  ...
  services: [
    {
      ...
      description: '24/7 rapid response for burst pipes, flooding, and urgent issues.',
      price: 'From $150',
    },
    {
      name: 'Drain Cleaning',
      description: 'Professional hydro-jetting and snaking for all drain types.',
      price: 'From $99',
    },
    {
      name: 'Water Heater Services',
      description: 'Installation, repair, and replacement of all water heater brands.',
      price: 'From $200',
    },
    {
