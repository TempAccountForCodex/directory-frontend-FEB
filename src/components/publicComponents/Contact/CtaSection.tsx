...
const purposes: Purpose[] = [
  ...
  },
  {
    ...
    description: 'Manage and optimize your business presence across TechieTribe.',
  },
  {
    id: 3,
    ...
    description: 'Help with settings, preferences, and access to your dashboard.',
  },
  {
    id: 4,
    ...
    description: 'Explore premium features and visibility options for your business.',
  },
];
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          <Box sx={{ maxWidth: '330px', pt: { md: 1 } }}>
            ...
            >
              TechieTribe brings clarity, not complexity — connecting you to the right support team
              instantly.
            </Typography>
            ...
            return (
              <Box
                ...
                sx={{
                  ...
                  bgcolor: '#ffffff',
                  border: '1px solid',
                  borderColor: isCenter ? 'rgba(15,118,110,0.12)' : 'rgba(0,0,0,0.065)',
                  boxShadow: isCenter
                ...
                >
                  <Box
                    sx={{
                      ...
                      borderRadius: '9px',
                      bgcolor:
                        isCenter || isHovered ? 'rgba(15,118,110,0.08)' : 'rgba(0,0,0,0.045)',
                      display: 'flex',
                      alignItems: 'center',
        ...
        >
          ...
          >
            ...
            <Typography sx={{ fontSize: 13, color: '#64748b' }}>
              Not sure?{' '}
              <Box component="span" sx={{ color: '#0f766e', fontWeight: 600, cursor: 'pointer' }}>
                Just contact us
              </Box>
            </Typography>
          </Box>
