...
export default function PricingFeaturesSection() {
  ...
  return (
    ...
    >
      ...
      >
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <Box key={i} sx={{ width: '1px', height: '100%', backgroundColor: '#eeeded' }} />
        ))}
      </Box>
      <Container maxWidth="xl" sx={{ position: 'relative' }}>
        <Box
        ...
        >
          <Typography
            variant="h1"
            sx={{
              fontSize: { xs: '2.5rem', sm: '3rem', md: '10.5vw' },
              fontWeight: 900,
              textAlign: 'center',
              color: '#1a1a1a',
              letterSpacing: '-0.05em',
      ...
      >
        <Box sx={{ mt: 4, px: { md: 5 } }}>
          ...
          >
            ...
            >
              Whether your business is small or large, we've included these essentials in every
              tier.
            </Typography>
          </Box>
