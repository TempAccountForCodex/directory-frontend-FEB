...
function buildSideFilterProps(overrides: Record<string, unknown> = {}) {
  return {
    ...
    setArea: vi.fn(),
    setItems: vi.fn(),
    items: [{ category: 'Accounting and Bookkeeping' }, { category: 'Legal Services' }],
    ...overrides,
  };
}
  ...
  return render(
    React.createElement(
      ...
      React.createElement(
        ThemeProvider,
        { theme },
        React.createElement(SideFilter, props as unknown as React.ComponentProps<typeof SideFilter>)
      )
    )
  );
}
