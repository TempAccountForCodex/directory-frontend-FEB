...
const DummyListing: Listing[] = [
  {
    ...
    aboutBusiness: 'We help businesses grow with innovative solutions and expert advice.',
    category: 'Consulting',
  ...
  },
  {
    ...
    latestProjectIntro: 'Launched a STEM program with 100% student participation.',
