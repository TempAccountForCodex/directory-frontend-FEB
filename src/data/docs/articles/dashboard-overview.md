Your dashboard is the home base for everything you create. This is a quick map of where things live.
...
1. [Create your first website](/docs/create-your-first-website) from a template.
2. [Publish your first listing](/docs/publish-your-first-listing) so people can find you.
3. Run the [launch checklist](/docs/launch-checklist) before you share it.

## Related

- [Create your first website](/docs/create-your-first-website)
- [Publish your first directory listing](/docs/publish-your-first-listing)
