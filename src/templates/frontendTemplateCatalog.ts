import type { TemplateCategory, TemplateSummary, TemplateType } from './templateApi';
...
export const FRONTEND_TEMPLATE_CATALOG: FrontendTemplateDefinition[] = [
  {
    ...
    slug: 'blog',
    name: 'Blog',
    description: 'Editorial layout tailored for insights and content marketing.',
    type: 'website',
    category: 'saas',
    version: '1.0.0',
  ...
  },
  {
    ...
    description: 'Creative-first portfolio template for individual professionals.',
    type: 'website',
    category: 'portfolio',
    version: '1.0.0',
  ...
  },
  {
    ...
    category: 'portfolio',
    version: '1.0.0',
    previewImage: '/assets/templateAssets/images/dummy/portfolio-photo-studio.png',
    pageCount: 4,
  },
  {
    id: 'store-basic',
  ...
  },
  {
    ...
    slug: 'company',
    name: 'Company',
    description: 'Multi-section company template for product and team storytelling.',
    type: 'website',
    category: 'saas',
    version: '1.0.0',
  ...
  },
  {
    ...
    slug: 'gardening',
    name: 'Gardening',
    description: 'Nature-focused local business template for garden and landscaping services.',
    type: 'website',
    category: 'business',
    version: '1.0.0',
  ...
  },
  {
    ...
    slug: 'education',
    name: 'Education',
    description: 'Structured template for courses, institutions, and educational programs.',
    type: 'website',
    category: 'education',
    version: '1.0.0',
  ...
  },
  {
    ...
    slug: 'restaurant',
    name: 'Restaurant',
    description: 'Restaurant website layout for menu highlights, reservations, and contact.',
    type: 'website',
    category: 'restaurant',
    version: '1.0.0',
  ...
  },
  {
    ...
    slug: 'plumbing',
    name: 'Plumbing',
    description: 'Service template for plumbing businesses with emergency and booking focus.',
    type: 'website',
    category: 'business',
    version: '1.0.0',
...
export const getFrontendWebsiteTemplates = (): TemplateSummary[] =>
  FRONTEND_TEMPLATE_CATALOG.filter((template) => template.type === 'website').map((template) => ({
    id: template.id,
    name: template.name,
...
export const getFrontendTemplateSlug = (templateId: string): string | null =>
  FRONTEND_TEMPLATE_CATALOG.find((template) => template.id === templateId)?.slug ?? null;

export const getFrontendTemplatePreviewImage = (templateId: string | null | undefined): string | null =>
  FRONTEND_TEMPLATE_CATALOG.find((template) => template.id === templateId)?.previewImage ?? null;
